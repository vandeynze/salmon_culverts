...
\item Our tool will explicitly consider hydrological constraints by assuming there are no habitat gains from upstream barrier culvert removal/replacement without first removing downstream barriers. So, you can plug in a budget and it will suggest a package of culverts restored or a restoration plan. Any restoration plan identified by the tool will not include an upstream culvert without including the relevant downstream culvert(s).
\end{enumerate}
