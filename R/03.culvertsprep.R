...
write_csv(df_culv_pure, "culverts_full_working.csv")
write_csv(df_culv_wrk_pure, "culverts_wrk_working.csv")
write_csv(df_culv_prj_pure, "culverts_prj_working.csv")
