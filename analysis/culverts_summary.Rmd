...
```{r action_count, echo=F, message=F}
unfactor <-
  function(x) {
...
```{r cost_per_culvert, echo=F, message=F}
# Cost per culvert distributions ====
# By basin
fig_costdist_action <-
  base_costdist_violin %+%
