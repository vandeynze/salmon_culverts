---
title: "Culvert Projects Summary"
author: "B. Van Deynze"
date: "March 27, 2020"
output:
  html_document:
...
![](..\output\figs\culverts\fig_countcost_action.png)
![](..\output\figs\culverts\fig_countcost_year.png)
![](..\output\figs\culverts\fig_countcost_basin.png)
![](..\output\figs\culverts\fig_countcost_source.png)
[Source glossery](#sources)
![](..\output\figs\culverts\fig_countcost_action_year.png)
![](..\output\figs\culverts\fig_countcost_source_action.png)
[Source glossery](#sources)
![](..\output\figs\culverts\fig_countcost_basin_action.png)
![](..\output\figs\culverts\fig_countcost_basin_year.png)
![](..\output\figs\culverts\fig_countcost_source_year.png)
[Source glossery](#sources)
![](..\output\figs\culverts\fig_countcost_basin_source.png)
[Source glossery](#sources)\
[Back to top](#pills)
...
![](..\output\figs\culverts\fig_prjcost_source.png)
[Source glossery](#sources)
![](..\output\figs\culverts\fig_prjcost_basin_year.png)
![](..\output\figs\culverts\fig_prjcost_source_year.png)
[Source glossery](#sources)

> **Observation:** The activity trends are driven largely by Oregon, especially dramatic drop-offs in reports by OWRI and REO.

![](..\output\figs\culverts\fig_prjcost_basin_source.png)
[Source glossery](#sources)\
...
![](..\output\figs\culverts\fig_cost_year.png)
![](..\output\figs\culverts\fig_cost_basin.png)
![](..\output\figs\culverts\fig_cost_source.png)
[Source glossery](#sources)
![](..\output\figs\culverts\fig_cost_year_basin.png)
![](..\output\figs\culverts\fig_cost_year_source.png)
[Source glossery](#sources)
![](..\output\figs\culverts\fig_cost_source_basin.png)
[Source glossery](#sources)\
...
![](..\output\figs\culverts\fig_costdist_action.png)
...
![](..\output\figs\culverts\fig_costdist_year.png)
...
![](..\output\figs\culverts\fig_costdist_basin.png)
![](..\output\figs\culverts\fig_costdist_source.png)
[Source glossery](#sources)\
...
![](..\output\maps\culverts\fig_map_cost.png)
...
![](..\output\maps\culverts\fig_map_year.png)
...
![](..\output\maps\culverts\fig_map_source.png)
[Source glossery](#sources)\
