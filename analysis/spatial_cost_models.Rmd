...
```{r fig.width=10, fig.height=10, echo=F, message=F, warning=F, animation.hook="gifski"}
set.seed(123456)
sigma = matrix( 
...
```{r echo=F, message=F, warning=F, fig.dim=c(8,12)}
...
```{r echo=F, message=F, warning=F, fig.dim=c(8,4)}
...
```{r message=F, warnings=F, echo=F, fig.dim=c(8,8)}
...
```
```{r message=F, warnings=F, fig.dim=c(8,8)}
